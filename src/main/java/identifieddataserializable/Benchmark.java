...
public class Benchmark
{
    ...
    public double getAverageSize()
    {
        ...
        {
            newRandom = random.nextInt(MAX_RANDOM);
            customer = new identifieddataserializable.Customer("MyNameIs" + newRandom, new Date(newRandom), ((newRandom % 2) == 0) ? Customer.Sex.MALE : Customer.Sex.FEMALE, "MyEmailIs" + newRandom, new ArrayList<>() {{ add(Long.valueOf(newRandom)); }});
